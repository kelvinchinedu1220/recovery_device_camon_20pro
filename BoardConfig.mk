...
# Board Boot Header
# Switch to version 4 since A15, moving recovery resources to vendor_boot
BOARD_BOOT_HEADER_VERSION := 4

# Board Default Values
# Switch to --vendor_cmdline since header v4
...
# Kernel - source
TARGET_KERNEL_CONFIG := CK7n_defconfig
TARGET_KERNEL_SOURCE := kernel/tecno/CK7n
...
TARGET_COPY_OUT_PRODUCT := product
TARGET_COPY_OUT_SYSTEM_EXT := system_ext4
